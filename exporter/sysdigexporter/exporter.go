...
func (sysdigExp *sysdigExporter) execute(ctx context.Context, writeReq *prompb.WriteRequest) error {
	...
	req.Header.Add("X-Scope-OrgID", "234")
	req.Header.Add("Content-Encoding", "snappy")
	req.Header.Add("Content-Type", "application/x-protobuf")
	req.Header.Add("User-Agent", "OpenTelemetry Sysdig Prometheus RW sink")
	req.Header.Add("Sysdig-Custom-Metric-Category", "PROMETHEUS_NON_COMPLIANT")
	req.Header.Add("Authorization", "BEARER "+sysdigExp.bearerToken)
