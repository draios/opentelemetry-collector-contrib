...
Sysdig Remote Write Exporter sends OpenTelemetry metrics
to Sysdig [remote write compatible
...
Non-cumulative counters are accepted. This exporter also supports Sysdig-specific
metadata generation.

:warning: Non-cumulative histogram, and summary OTLP metrics are
...
- `bearer_token`: required for authorization with Sysdig
...
exporters:
  sysdig:
    endpoint: "https://sysdigprw/api/v1/push"
    bearer_token: "token"
