module github.com/open-telemetry/opentelemetry-collector-contrib/exporter/sysdigexporter
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/sysdig v0.71.0
