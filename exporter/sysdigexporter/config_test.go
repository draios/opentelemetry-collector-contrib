...
func TestLoadConfig(t *testing.T) {
	...
	fmt.Println(component.NewIDWithName(typeStr, "2").String())
	fmt.Println(cm.Sub(component.NewIDWithName(typeStr, "2").String()))
	...
	tests := []struct {
		...
		{
			id:       component.NewIDWithName(typeStr, "settings1"),
			expected: createDefaultConfig(),
		},
		{
			id: component.NewIDWithName(typeStr, "settings2"),
			expected: &Config{
